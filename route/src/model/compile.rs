...
pub fn compile_model(
    ...
    // #490: turn penalties are single-sourced by `ebg::turn_penalty::for_mode`
    // (re-read from the model JSON at step 4). The compile path no longer
    // parses or carries a turn-penalty config.
