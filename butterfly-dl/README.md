...
butterfly-dl is designed to integrate with standard OSM processing pipelines:

```bash
# Stream output for processing
butterfly-dl europe/belgium - | your-processing-tool

# Download for local processing
butterfly-dl planet
your-tool planet-latest.osm.pbf
```
